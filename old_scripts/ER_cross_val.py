...
accuracy_file = os.path.join(result_dir, "accuracy_file_ER_status.txt")
accuracy_file_results = os.path.join(result_dir, "accuracy_file_result_ER_status.txt")
...
for num in num_genes:
    ...
    final_results = os.path.join(result_dir, "ER_results_df.tsv")
