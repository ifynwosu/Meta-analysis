...
write_tsv(common_meta_genes, file.path("/Data/results/", "ER_status_common_genes.tsv"))
...
png("/Data/results/ER_status_heatmap.png", width = 24, height = 12, units = "in", res = 300)
...
write_tsv(top_genes, file.path("/Data/results/", "ER_heatmap_genes.tsv"))
