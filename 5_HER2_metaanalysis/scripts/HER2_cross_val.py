...
accuracy_file = open("accuracy_file_HER2.txt", "w")
accuracy_file_results = open("accuracy_file_HER2_result.txt", "w")

# define directories
meta_results_dir = "Data/HER2_meta_results"
cross_val_data_dir = "Data/cross_validation_HER2"
