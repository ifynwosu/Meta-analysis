...
cross_validation_results_dir <- "/inwosu/Meta_Analysis/Data/cross_validation_HER2"

if (!dir.exists(cross_validation_results_dir)) {
  dir.create(cross_validation_results_dir)
}

metadata_dir <- "/inwosu/Meta_Analysis/Data/HER2_metadata"
...
# results_dir <- "/inwosu/Meta_Analysis/Data/HER2_meta_results"
