...
HER2_meta_results_dir <- "/Data/results/HER2_status"
...
meta_dir <- "/Data/metadata/HER2_status" 
...
dataset_vector = str_replace_all(expr_dir_paths, c("/Data/expression_data/HER2_status/" = "", ".tsv.gz" = ""))
...
phenoGroups = rep("HER2_status", length(meta_dir_paths))
