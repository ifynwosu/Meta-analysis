...
ER_meta_results_dir <- "/inwosu/Meta_Analysis/Data/ER_meta_results"
...
meta_dir <- "/inwosu/Meta_Analysis/Data/ER_metadata"  
...
dataset_vector = str_replace_all(expr_dir_paths, c("/inwosu/Meta_Analysis/Data/ER_expression_data/" = "", ".tsv.gz" = ""))
...
# source("/inwosu/Meta_Analysis/1_prepare_data/functions/draw_Heatmap.R")
