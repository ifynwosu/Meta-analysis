...
for (i in seq_along(list_all_exprdata)) {
  ...
  meta_results <- metaAnalysisDE(meta_object, typeMethod = "REM", missAllow = 0.2, proportionData = 0.5) 
  
  #test_for_heterogeneity[i] <- heterogeneityTest(meta_object,probs=c(0,0.25,0.5,0.75))
