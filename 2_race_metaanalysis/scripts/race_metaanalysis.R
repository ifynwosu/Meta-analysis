...
# full_meta_object_output <- "race_meta_object.txt"
# write.table(full_meta_object, file = full_meta_object_output, quote = FALSE, row.names = FALSE, col.names = FALSE)

# full_meta_result_output <- "race_meta_result.txt"
# write.table(full_meta_results, file = full_meta_result_output, quote = FALSE, row.names = FALSE, col.names = FALSE)

source("/prepare_data/functions/draw_Heatmap.R")
png("/Data/results/race_heatmap.png", width = 30, height = 12, units = "in", res = 300)
...
write_tsv(top_genes, file.path("/Data/results/", "race_genes.tsv"))
