...
results_df <- read_tsv("/inwosu/Meta_Analysis/Data/cross_validation_results/accuracy_file_result_PR_status.txt", col_names = F) 
names(results_df) <- c("Dataset_ID", "num_genes", "gene_predictor", "Balanced accuracy") 

png("/inwosu/Meta_Analysis/Data/cross_validation_results/PR_plot.png", width = 18, height = 10, units = "in", res = 300)
results_df %>%
...
# 
# accuracy_file <- read_tsv("/inwosu/Meta_Analysis/accuracy_file_PR.txt", col_names = F) 
