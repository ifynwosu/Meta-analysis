...
results_df <- read_tsv("/inwosu/Meta_Analysis/Data/cross_validation_results/accuracy_file_result_HER2_status.txt", col_names = F) 
names(results_df) <- c("Dataset_ID", "num_genes", "gene_predictor", "Balanced accuracy") 

png("/inwosu/Meta_Analysis/Data/cross_validation_results/HER2_plot.png", width = 18, height = 10, units = "in", res = 300)
results_df %>%
