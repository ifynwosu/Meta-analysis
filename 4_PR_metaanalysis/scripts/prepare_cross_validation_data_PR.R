...
cross_validation_results_dir <- "/inwosu/Meta_Analysis/Data/cross_validation_PR"

if (!dir.exists(cross_validation_results_dir)) {
  dir.create(cross_validation_results_dir)
}

metadata_dir <- "/inwosu/Meta_Analysis/Data/PR_metadata"
...
# results_dir <- "/inwosu/Meta_Analysis/Data/PR_meta_results"
